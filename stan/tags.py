...
from stan import Proto, Tag, directive, raw, xml, CommentProto, invisible, slot, cdata
...
__all__ = tags + ['invisible', 'comment', '_dir', '_del', '_object', '_map', 'drange', 'Tag', 'directive', 'xml', 'raw', 'slot', 'cdata'] + ['_%s' % x for x in range(100)]
